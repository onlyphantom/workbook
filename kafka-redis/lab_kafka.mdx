...
After successfully creating the table with the corresponding schema, we can then populate the table using this [data](https://github.com/onlyphantom/coursebook/blob/main/datasets/idx_company_profile_080824.csv).
...
st.set_page_config(layout='wide', page_title='Coursebook Dashboard')
```
